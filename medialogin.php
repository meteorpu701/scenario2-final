...
<body>
    ...
    <div class="media-list">
        ...
        <img src="green.png" alt="Audio File Cover">
        <a href="#" id="mediaLink">Hypnosis 2</a>
        </div>
        <div class="media-item" data-title="Audio Title A">
        <img src="green.png" alt="Audio File Cover">
        <a href="#" id="mediaLink">Hypnosis 3</a>
        </div>
        <div class="media-item" data-title="Audio Title A">
        <img src="green.png" alt="Audio File Cover">
        <<a href="#" id="mediaLink">Hypnosis 4</a>
        </div>
        <div class="media-item" data-title="Audio Title A">
        <img src="green.png" alt="Audio File Cover">
        <a href="#" id="mediaLink">Hypnosis 5</a>
        </div>
        <div class="media-item" data-title="Audio Title A">
        <img src="green.png" alt="Audio File Cover">
        <a href="#" id="mediaLink">Hypnosis 6</a>
        </div>
        <div class="media-item" data-title="Audio Title A">
        <img src="green.png" alt="Audio File Cover">
        <a href="#" id="mediaLink">Hypnosis 7</a>
        </div>
        <div class="media-item" data-title="Audio Title A">
        <img src="green.png" alt="Audio File Cover">
        <a href="#" id="mediaLink">Hypnosis 8</a>
        </div>
        <div class="media-item" data-title="Audio Title A">
        <img src="green.png" alt="Audio File Cover">
        <a href="#" id="mediaLink">Hypnosis 9</a>
        </div>
        <div class="media-item" data-title="Audio Title A">
        <img src="green.png" alt="Audio File Cover">
        <a href="#" id="mediaLink">Hypnosis 10</a>
        </div>
        <div class="media-item" data-title="Audio Title A">
        <img src="green.png" alt="Audio File Cover">
        <a href="#" id="mediaLink">Hypnosis 11</a>
        </div>
        <div class="media-item" data-title="Audio Title A">
        <img src="green.png" alt="Audio File Cover">
        <a href="#" id="mediaLink">Hypnosis 12</a>
        </div>
    </div>
    </div>
